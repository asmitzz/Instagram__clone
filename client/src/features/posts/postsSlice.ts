...
import { PostData,PostsIntialState, PostResponse,UploadPostData, Post } from "./posts.types";
...
export const fetchComments = createAsyncThunk<{post:Post},{token:string,postId:string}>("posts/fetchcomments",async({token,postId},thunkApi) => {
